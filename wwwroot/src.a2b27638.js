...
var author$project$Main$initialModel = function (baseUrl) {
	return {baseUrl: baseUrl, flash: '', newTodo: '', todos: _List_Nil};
};
var author$project$Todo$Todo = F3(
	function (id, name, isComplete) {
		return {id: id, isComplete: isComplete, name: name};
	});
...
var author$project$Todo$todoDecoder = A4(
	elm$json$Json$Decode$map3,
	author$project$Todo$Todo,
	A2(elm$json$Json$Decode$field, 'id', elm$json$Json$Decode$int),
	A2(elm$json$Json$Decode$field, 'name', elm$json$Json$Decode$string),
	A2(elm$json$Json$Decode$field, 'isComplete', elm$json$Json$Decode$bool));
...
var author$project$Todo$getTodos = F2(
	function (baseUrl, msg) {
...
var author$project$Main$init = function (baseUrl) {
	return _Utils_Tuple2(
		author$project$Main$initialModel(baseUrl),
		A2(author$project$Todo$getTodos, baseUrl, author$project$Main$ReceiveTodos));
};
...
var author$project$Main$ReceiveDeleteTodo = function (a) {
	return {$: 'ReceiveDeleteTodo', a: a};
};
var author$project$Main$ReceiveTodo = function (a) {
	return {$: 'ReceiveTodo', a: a};
};
var author$project$Main$UpdateTodo = function (a) {
	return {$: 'UpdateTodo', a: a};
};
var author$project$Todo$defaultTodo = {id: 0, isComplete: false, name: ''};
...
var author$project$Todo$encodeTodo = function (q) {
	return elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'id',
				elm$json$Json$Encode$int(q.id)),
				_Utils_Tuple2(
				'name',
				elm$json$Json$Encode$string(q.name)),
				_Utils_Tuple2(
				'isComplete',
				elm$json$Json$Encode$bool(q.isComplete))
			]));
};
...
var author$project$Todo$createTodo = F3(
	function (baseUrl, todo, msg) {
		return elm$http$Http$post(
			{
				body: elm$http$Http$jsonBody(
					author$project$Todo$encodeTodo(
						_Utils_update(
							author$project$Todo$defaultTodo,
							{name: todo}))),
				expect: A2(elm$http$Http$expectJson, msg, author$project$Todo$todoDecoder),
				url: _Utils_ap(
					baseUrl,
					A2(
						elm$url$Url$Builder$relative,
...
var author$project$Todo$deleteTodo = F3(
	function (baseUrl, todo, msg) {
		return elm$http$Http$request(
			{
...
var author$project$Todo$updateTodo = F3(
	function (baseUrl, todo, msg) {
		return elm$http$Http$request(
			{
				body: elm$http$Http$jsonBody(
					author$project$Todo$encodeTodo(todo)),
				expect: A2(elm$http$Http$expectJson, msg, author$project$Todo$todoDecoder),
				headers: _List_Nil,
				method: 'PUT',
				timeout: elm$core$Maybe$Nothing,
	...
	function (msg, model) {
		switch (msg.$) {
			...
			case 'UpdateTodo':
				...
				if (result.$ === 'Ok') {
					...
					var todos = A2(
						elm$core$List$map,
						function (t) {
							return _Utils_eq(t.id, todo.id) ? todo : t;
						},
						model.todos);
					return _Utils_Tuple2(
						_Utils_update(
			...
			case 'AddTodo':
				return _Utils_Tuple2(
					model,
					A3(author$project$Todo$createTodo, model.baseUrl, model.newTodo, author$project$Main$ReceiveTodo));
			case 'CompleteTodo':
				var todo = msg.a;
				return _Utils_Tuple2(
					model,
					A3(
						author$project$Todo$updateTodo,
						model.baseUrl,
						_Utils_update(
							todo,
							{isComplete: !todo.isComplete}),
						author$project$Main$UpdateTodo));
			case 'ReceiveTodo':
				var result = msg.a;
				if (result.$ === 'Ok') {
					var todo = result.a;
			...
			case 'DeleteTodo':
				...
				return _Utils_Tuple2(
					model,
					A3(author$project$Todo$deleteTodo, model.baseUrl, todo, author$project$Main$ReceiveDeleteTodo));
			case 'ReceiveDeleteTodo':
				var result = msg.a;
				if (result.$ === 'Ok') {
					var todo = result.a;
					return _Utils_Tuple2(
...
var author$project$Main$UpdateTodoContent = function (a) {
	return {$: 'UpdateTodoContent', a: a};
};
...
var nathanjohnson320$elm_ui_components$ElmUIC$Theme$Small = {$: 'Small'};
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						rtfeldman$elm_css$Html$Styled$text(todo.name)
					])),
				A2(
				rtfeldman$elm_css$Html$Styled$div,
				_List_fromArray(
				...
				_List_fromArray(
					[
						...
						_Utils_update(
							...
							{kind: nathanjohnson320$elm_ui_components$ElmUIC$Theme$Danger, size: nathanjohnson320$elm_ui_components$ElmUIC$Theme$Small}),
						_List_fromArray(
							[
								author$project$Main$onClick(
								author$project$Main$DeleteTodo(todo))
							]),
						_List_fromArray(
							[
...
var nathanjohnson320$elm_ui_components$ElmUIC$Navbar$navbar = F4(
	function (theme, model, attr, inner) {
		var titleAttrs = model.redirectHome ? _List_fromArray(
			[
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						rtfeldman$elm_css$Css$fontFamilies(nathanjohnson320$elm_ui_components$ElmUIC$Theme$defaultTheme.font)
					]))
			]),
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								rtfeldman$elm_css$Html$Styled$Attributes$placeholder('New Todo'),
								rtfeldman$elm_css$Html$Styled$Events$onInput(author$project$Main$UpdateTodoContent),
								author$project$Main$onEnter(author$project$Main$AddTodo),
								rtfeldman$elm_css$Html$Styled$Attributes$value(model.newTodo)
							]),
						_List_Nil),
						A4(
						nathanjohnson320$elm_ui_components$ElmUIC$Button$button,
						...
						_Utils_update(
							nathanjohnson320$elm_ui_components$ElmUIC$Button$defaultButton,
							{size: nathanjohnson320$elm_ui_components$ElmUIC$Theme$Small}),
						_List_fromArray(
							[
								author$project$Main$onClick(author$project$Main$AddTodo)
							]),
						_List_fromArray(
							[
				...
				A2(elm$core$List$map, author$project$Main$todoItem, model.todos))
			]));
};
...
_Platform_export({'Main':{'init':author$project$Main$main(elm$json$Json$Decode$string)({"versions":{"elm":"0.19.0"},"types":{"message":"Main.Msg","aliases":{"Todo.Todo":{"args":[],"type":"{ id : Basics.Int, name : String.String, isComplete : Basics.Bool }"}},"unions":{"Main.Msg":{"args":[],"tags":{"NoOp":[],"AddTodo":[],"UpdateTodoContent":["String.String"],"ReceiveTodos":["Result.Result Http.Error (List.List Todo.Todo)"],"ReceiveTodo":["Result.Result Http.Error Todo.Todo"],"UpdateTodo":["Result.Result Http.Error Todo.Todo"],"CompleteTodo":["Todo.Todo"],"DeleteTodo":["Todo.Todo"],"ReceiveDeleteTodo":["Result.Result Http.Error Todo.Todo"]}},"Basics.Bool":{"args":[],"tags":{"True":[],"False":[]}},"Basics.Int":{"args":[],"tags":{"Int":[]}},"List.List":{"args":["a"],"tags":{}},"Result.Result":{"args":["error","value"],"tags":{"Ok":["value"],"Err":["error"]}},"String.String":{"args":[],"tags":{"String":[]}},"Http.Error":{"args":[],"tags":{"BadUrl":["String.String"],"Timeout":[],"NetworkError":[],"BadStatus":["Basics.Int"],"BadBody":["String.String"]}}}}})}});
...
var app = _main.Elm.Main.init({
  node: node,
  flags: "https://localhost:5001/api/"
});
